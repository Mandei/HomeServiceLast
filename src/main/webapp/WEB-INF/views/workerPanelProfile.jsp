            ...
            <a href="workerPanel.html"> <div class="logo">
              ...
              <div class="content " >
                    <div class=" container  details border ">
                        ...
                        <div class"container " >
                            <form action="updateWorker.html" method="post">
                                <div class="row m-3 ">
                                  <div class="col">
                                    <input type="text" class="form-control border-bottom" placeholder="First name" value="${worker.firstName }">
                                  </div>
                                  <div class="col">
                                    <input type="text" class="form-control border-bottom" placeholder="Last name" value="${worker.lastName }">
                                  </div>
                                </div>
                                <div class="row mx-3">
                                    <div class="col">
                                      <input type="text" class="form-control border-bottom" placeholder="Contact" value="${worker.contactNumber }">
                                    </div>
                                    <div class="col">
                                      <input type="text" class="form-control border-bottom" placeholder="Email" value="${worker.email}">
                                    </div>
                                </div >
                                <div class="row m-3">
                                    <div class="col">
                                            <input type="text" class="form-control border-bottom" placeholder="Address" value="${worker.locality }">
                                    </div>
                                </div>
