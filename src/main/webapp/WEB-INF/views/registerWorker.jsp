                        ...
                        <div class="col-md-7 register-right">
                            ...
                            <div class="register-form">
                              <div class="form-group">
                                <input required type="text" name="firstName" id="fname" value="${worker.firstName}" class="form-control" placeholder="First name"/>
                                <span id="firstname" class="text-danger font-weight-bold"></span>
                              </div>
                            <div class="form-group">
                                <input required type="text" name="lastName" id="lname" value="${worker.lastName}" class="form-control" placeholder="Last name"/>
                            ...
                            <div class="form-group">
                                <input required type="text" name="contactNumber" id="contact" value="${worker.contactNumber}" class="form-control" placeholder="Contact"/>
                                <span id="contactNo" class="text-danger font-weight-bold"></span>
                              </div>
                            <div class="form-group">
                                <input required type="password" name="pwd" id="pswd" class="form-control" placeholder="Password"/>
                                <span id="password" class="text-danger font-weight-bold"></span>
                           </div>
                            <div class="form-group">
                                <input required type="password" name="conpswd"  id="conpswd" class="form-control" placeholder="Re-Enter Password"/>
