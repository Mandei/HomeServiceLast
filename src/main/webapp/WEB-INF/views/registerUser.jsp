...
<!-- Message Display here -->
  ...
  alert("Email Id already Exists ! Please try with a different email");
        ...
        <form action="registerUser.html" method="post" id="registerform" onsubmit="return validation()">  
          <div class="container">
            <div class="row">
                        ...
                        <div class="col-md-7 register-right">
                            ...
                            <div class="register-form">
                                <div class="form-group">
                                    <input  type="text" name="firstName" id="firstName" value="${user.firstName }" class="form-control" placeholder="First name"/>
                                    <span id="fname" class="text-danger font-weight-bold"></span>
                                  </div>
                                <div class="form-group">
                                    <input  type="text" name="lastName" id="lastName" value="${user.lastName }" class="form-control" placeholder="Last name"/>
                                ...
                                <div class="form-group">
                                    <input  type="text" name="contactNumber"  id="contactNumber" value="${user.contactNumber }"  class="form-control" placeholder="Contact"/>
